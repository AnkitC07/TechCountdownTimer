...
import OnboardingScreens from "./Onboarding/index.jsx";
...
export default function Homepage() {
  ...
  async function getStoreDetails() {
    ...
    Shopify.shop =   getdata.data.storename
                              ...
                              <div className="Polaris-EmptyState__Details">
                                <div className="Polaris-TextContainer">
                                  ...
                                  <div className="Polaris-EmptyState__Content">
                                    <p>
                                      Start by creating your first countdown
                                      timer and publishing it to your store.
                                    </p>
                                  </div>
                                </div>
